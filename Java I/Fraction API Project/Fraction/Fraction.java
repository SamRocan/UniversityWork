...
public interface Fraction extends Comparable<Fraction> {
    ...
    /**
     * Returns an <pre>int</pre> of the lowest common multiple of <pre>num1</pre> and <pre>num2</pre>
     * @param num1 of f Denominator.
     * @param num2 of <pre>this</pre> Denominator.
     * @return the result of the comparison
     */
    public int LCM(int num1, int num2);

    /**
     * Returns a <pre>Int</pre> of the GCD of <pre>a</pre> and <pre>b</pre>
     * @param a of <pre>this</pre> Numerator.
     * @param b of <pre>this</pre> Denominator.
     * @return the result of the comparison
     */
